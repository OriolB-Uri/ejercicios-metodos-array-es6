...
let nuevosAnimales = animales.map((animal) => animal.toUpperCase()); // TODO
...
let pacientesVisitados = pacientes.map((paciente) => paciente.ultimaVisita = new Date().toLocaleDateString()); 
...
let pacientesAvisos = pacientes.map(obj => ({ ...obj, avisos: obj.ultimaVisitaPagada ? " " : "Paciente Moroso"})); // TODO
